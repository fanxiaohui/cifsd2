 ...
 * in fid table.
 */
void close_opens_from_fibtable(struct cifsd_session *sess, struct cifsd_tree_connect *tcon)
{
	struct cifsd_file *file;
	struct fidtable *ftab;
	int id;
 ...
 */
int cifsd_insert_in_global_table(struct cifsd_session *sess, struct cifsd_file *fp)
{
	int persistent_id;
	struct fidtable *ftab;
